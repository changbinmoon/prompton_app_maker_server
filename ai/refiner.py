...
def build_android_guardrails(job_id: str) -> str:
    ...
    return (
        ...
        "- Ignore Client-supplied Android API levels. Always use minSdk 26, compileSdk 36, "
        "targetSdk 36, and Android SDK Build Tools 36.0.0.\n"
        "- Use exactly Android Gradle Plugin 8.10.1, Gradle 8.11.1, JDK 17, Kotlin 1.9.24, "
        "Compose compiler 1.5.14, and Compose BOM 2024.06.00; do not mix incompatible "
        "toolchain or Compose versions.\n"
        "- Set Java sourceCompatibility, targetCompatibility, and Kotlin jvmTarget to 17.\n"
        "- Use only Compose APIs available in the declared BOM. Pass a Float value, not a "
        "lambda, to Material 3 LinearProgressIndicator progress with this stack.\n"
        "- Add explicit @OptIn annotations for every experimental Compose API used, including "
        "ExperimentalFoundationApi for foundation pager APIs.\n"
